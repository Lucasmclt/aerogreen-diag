...
def render_fit_test():
    render_page_header(
        ...
        "Pré-qualification indicative pour vérifier si le cas d’entreprise se prête au démonstrateur AeroGreen.",
        "Pré-analyse"
    )
    ...
    if st.button("Analyser l’adéquation"):
        ...
        <div class='card'>
            ...
            <div class='feature-text'>
                Ce score sert à estimer si le cas d’entreprise se prête à une analyse plus détaillée dans le prototype.
            </div>
        </div>
