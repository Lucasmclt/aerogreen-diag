...
def render_upgrade_panel():
    ...
    <div class='upgrade-panel'>
        <div>
            <div class='section-title' style='color:#cbd5e1;'>Espace de démonstration</div>
            <h3>Explorer le diagnostic complet</h3>
            <p>
                Accédez au questionnaire guidé, à l’historique des cas, au démonstrateur de suivi
                et au rapport exploratoire PDF.
            </p>
        </div>
    </div>
    """, unsafe_allow_html=True)
