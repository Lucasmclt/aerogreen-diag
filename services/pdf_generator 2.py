...
class AeroGreenPDF(FPDF):
    def header(self):
        ...
        self.cell(0, 6, "Rapport de travail - diagnostic RSE numerique", 0, 1, "C")
        self.ln(8)
...
def create_working_report_pdf_bytes(company: dict, result: dict, recommendations: list[dict], fit_score: float, fit_result: str):
    pdf = AeroGreenPDF()
    pdf.add_page()

    # Cover summary
    pdf.section_title("1. Synthese indicative")
    ...
    pdf.cell(55, 6, "Estimation indicative", 0, 0)
    ...
    pdf.section_title("7. Reserve methodologique")
    pdf.set_font("Arial", "", 9)
    pdf.set_text_color(100, 116, 139)
    pdf.multi_cell(
        0,
        ...
        safe_text(
            ...
            "Les resultats sont indicatifs et reposent sur les donnees declarees dans l'outil."
        )
    )
